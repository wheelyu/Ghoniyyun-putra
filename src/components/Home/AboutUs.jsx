...
const About = () => {
    ...
    return (
        <div className=" bg-gradient-to-r from-primary to-pink-500 bg-opacity-85 py-32 px-4 h-fit w-full mx-auto flex flex-col  items-center justify-center">
            ...
            <div 
                className="grid grid-cols-3 gap-8 w-10/12 mt-12 items-center"
            >
