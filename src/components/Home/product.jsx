...
const OurProduct = () => {
    const products = [
        ...
        id: 1,
        title: "Contractor",
        image: "contactor.jpg", // Ganti dengan URL gambar produk Anda
        },
        {
        id: 2,
        title: "Trading Wholesaler",
        image: "trading.jpg", // Ganti dengan URL gambar produk Anda
        },
        {
        id: 3,
        title: "Operator",
        image: "operator.jpg", // Ganti dengan URL gambar produk Anda
        },
    ];
