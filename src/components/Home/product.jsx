...
const OurProduct = () => {
    ...
    return (
        <div className="bg-white bg-opacity-90 mb-1 pt-12 sm:pt-16 md:pt-20 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-48">
        ...
        >
            {category.map((category, index) => (
                <SwiperSlide key={index}>
                    <div className="service-card w-full shadow-lg hover:shadow-xl 
